...
## Результат
Лучшим решением оказалась вариация [алгоритма TIFU KNN](https://arxiv.org/pdf/2006.00556.pdf). С её помощью удалось получить значение метрики **0.3925**, что означает, что точность (в широком понимании) предсказания следующей корзины пользователя составляет около **40%**.  
